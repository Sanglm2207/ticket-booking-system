...
import net.javaguides.jobhunter.domain.response.file.ResUploadFileDTO;
import net.javaguides.jobhunter.service.Impl.FileServiceImpl;
import net.javaguides.jobhunter.util.annotation.ApiMessage;
import net.javaguides.jobhunter.util.error.StorageException;

@RestController
@RequestMapping("/api/v1")
public class FileController {

    @Value("${kaidev99.upload-file.base-uri}")
    ...
    public ResponseEntity<ResUploadFileDTO> upload(
        ...
        // store file
        String uploadFile = this.fileServiceImpl.store(file, folder);
